...
<section class="blog-posts grid-system">
  <div class="container">
    <div class="row">
      <div class="col-lg-8">
        <div class="all-blog-posts" style="border: 1px solid red" ;>
          <div class="row">
              ...
              <div class="col-lg-6" style="border: 1px solid green">
                <div class="blog-post">
                  <div class="blog-thumb">
                    <img src="<?php echo $article['loremPicsum'] ?>" alt="lorem picsum">
                  </div>
                  <div class="down-content">
                    ...
                    <ul class="post-info">
                      <li><a href="#"><?php echo $article["role"] ?></a></li>
                      <li><a href="#"><?php echo $article["date"] ?></a></li>
                      <li><a href="#"><?php echo $article["nbComments"] ?></a></li>
                    </ul>
                    <p><?php echo $article["lorem"] ?></p>
